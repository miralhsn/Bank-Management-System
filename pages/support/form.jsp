...
<body>
    ...
    <div class="form-container">
        <c:set var="formAction" value="${support.id == null ? '/supports/save' : '/supports/update'}"/>
        <form:form action="${pageContext.request.contextPath}${formAction}" method="post" modelAttribute="support">
            <form:hidden path="id"/>
            <div>
            ...
            <div>
                ...
                <form:input path="issue" id="issue"/>
            </div>
            <div>
